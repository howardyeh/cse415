# from shihhao_agent import *

# print(introduce())
# while True:
#     the_input = input('TYPE HERE:>> ')
#     the_output = respond(the_input)
#     print(the_output)
#     if the_output=="goodbye":
#         break
...
import shihhao_agent as agentA
# import yitings_agent as agentB
import TsungDa_agent as agentB
# import shihhao_agent as agentB
